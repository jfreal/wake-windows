...
**Competitor verdict:** Not a clean gap for the tagline (Napper owns "non-judgmental"), real opportunity in the mechanics â€” win on concrete UI, not a slogan.
...
Huckleberry draws repeated complaints that rigid SweetSpot times cause guilt/anxiety â€” parents describe "fighting" the clock. Smart Sleep Coach's gamified "You're now a sleep novice!" reinforcement is pressuring to some. "Empty-tracker guilt" (blank Tummy Time/milestone sections) is a documented landmine, as is "rigid-schedule anxiety" from a countdown you can't meet.

## Competitor comparison
Napper markets "a gentle, understanding friend who's there to help, not judge" â€” so the *positioning* is taken. But no competitor solves the pain in *execution*: they still show single target times, streaks, and always-visible empty trackers.

## Our approach (spec â€” the mechanics)
- **Ranges, not a single target time.** "Aim for roughly 9:15â€“9:45," never "9:23." This reduces the "I missed it" failure feeling and is more scientifically honest (Tier-3 windows are ranges anyway).
- **No streaks, no scores, no grades.** Nothing to break, nothing to lose.
- **Out-of-range informs, never scolds.** Reassuring, plain copy tied to normal-variation evidence (Iglowstein 2003) â€” "this is within normal variation," not "you're off track."
...
## Edge cases & gotchas
- Ranges must still be actionable â€” too wide and they're useless; keep to the cited window.
...
## Evidence & citations
[Napper â€” "help, not judge" (TechRadar)](https://www.techradar.com/computing/websites-apps/napper) Â· [Smart Sleep Coach â€” gamification](https://screensdesign.com/showcase/smart-sleep-coach-by-pamperstm) Â· Iglowstein 2003 (normal-variation sleep-duration reference; research file 00).

## Effort
Low â€” mostly copy and display choices.
