...
1. **The honest framing, up top:** "Total 24-hour sleep durations are consensus science (Tier 1). The specific wake-window minute-charts are a widely-used heuristic (Tier 3) — sources disagree and there is no RCT. We use them as flexible starting ranges, labeled honestly." Include the Canapari quote.
2. **The tables:** 24h totals by age with T1 sources (AASM 2016, NSF 2015); wake-window ranges by age with T3 sources; nap-transition ages (T3). Every row carries a Tier badge (B01) and a named, linked citation.
...
## Evidence & citations
Tier 1: AASM 2016 (Paruthi, JCSM), NSF 2015 (Hirshkowitz, Sleep Health), AAP 2022 safe sleep. Tier 2: Mindell 2016 (PubMed 27252030), Iglowstein 2003 (Pediatrics). Tier 3: Taking Cara Babies, Huckleberry, Cleveland Clinic wake-window charts. Skeptic anchor: Canapari (Yale) — "not taught, discussed, or researched" and numbers "do not seem to be based on any scientific evidence."
