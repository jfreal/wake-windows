...
- **Numbers disclose what they're made of.** The observed 7-day sleep average (D01) names its sample and says it counts only logged sleep, rather than handing a partially-logged parent a confident number to feel behind against.
