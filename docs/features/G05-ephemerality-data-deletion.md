...
**Competitor verdict:** Confirmed gap — everyone wants to retain you forever; a tool that admits you'll grow out of it is unoccupied.

## Problem / user need
Wake-window scheduling is a phase — you need it for months, then your child outgrows it. Every competitor is built to keep you: retained accounts, dormant subscriptions, data you can't fully delete. Parents end up paying for tools they no longer use because auto-renew stayed on, and their child's data lingers in a database indefinitely.
...
## Our approach (spec)
- **"It goes away when you're done."** One-click **delete everything** — because data lives on-device / in-URL (G01), deletion is real and immediate, not a support ticket.
...
- The product **admits you'll grow out of it** — copy that says, honestly, "when your baby ages out of naps, you won't need us; thanks for stopping by." A one-time tip, not a lifetime hostage.
...
## Edge cases & gotchas
- Deletion must be genuinely complete (local storage, cache, any shared URL guidance) — no orphaned data.
- If opt-in sync ever exists, it needs its own explicit server-side delete.
- Don't turn "still using this?" into engagement bait — that betrays the whole stance.

## Evidence & citations
[FEATURE-INDEX — auto-renew/billing landmines & privacy](./FEATURE-INDEX.md) · Glow — [California AG settlement](https://oag.ca.gov/news/press-releases/attorney-general-becerra-announces-landmark-settlement-against-glow-inc-%E2%80%93) · founder brief (twin parent, auto-renew traps, "goes away when you're done").

## Effort
Low — clearing local/URL state plus copy; near-free given the G01 architecture.

## Risks / open questions
"Graceful exit" runs counter to standard retention economics — but that's the point, and the tip jar (G02) means retention isn't the business model.
